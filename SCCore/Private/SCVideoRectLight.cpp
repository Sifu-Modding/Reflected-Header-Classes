...
ASCVideoRectLight::ASCVideoRectLight(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer.SetDefaultSubobjectClass<USCVideoRectLightComponent>(TEXT("LightComponent0"))) {
