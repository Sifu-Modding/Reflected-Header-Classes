...
void UScrollBox::ScrollWidgetIntoView(UWidget* WidgetToFind, bool AnimateScroll, FVector2D ScrollOffset, EDescendantScrollDestination ScrollDestination, float Padding) {
}
